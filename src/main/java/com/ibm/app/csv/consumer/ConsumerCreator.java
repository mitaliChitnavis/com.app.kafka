package com.ibm.app.csv.consumer;
...
import com.ibm.app.csv.serializer.CustomDeserializer;


public class ConsumerCreator {
	public static Consumer<Long, CSVRecord> createConsumer() {
		...
		final Consumer<Long, CSVRecord> consumer = new KafkaConsumer<Long, CSVRecord>(props);
